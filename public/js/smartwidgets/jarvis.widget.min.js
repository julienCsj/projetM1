/*! SmartAdmin - v1.4.0 - 2014-06-04 */!function (a, b, c, d) {
    function e(b, c) {
    ...
    e.prototype = {_settings: function () {
            ...
            if (b._settings(), a("#" + b.objId).length || alert("It looks like your using a class instead of an ID, dont do that!"), b.o.rtl === !0 && a("body").addClass("rtl"), a(b.o.grid).each(function () {
                ...
                for (var e in c.grid) {
                    ...
                    for (var g in c.grid[e].section)
                        f.append(a("#" + c.grid[e].section[g].id))
                }
            }
            ...
            d._settings(), d.widget.on(clickEvent, ".jarviswidget-toggle-btn", function (b) {
                ...
                a.SmartMessageBox({title: "<i class='fa fa-times' style='color:#ed1c24'></i> " + d.o.labelDelete + ' "' + f + '"', content: "Warning: This action cannot be undone", buttons: "[No][Yes]"}, function (b) {
