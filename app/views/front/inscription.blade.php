...
<header id="header">
    ...
    <span id="extr-page-header-space"> <span class="hidden-mobile">Déjà inscrit ?</span> <a href="{{URL::route('index')}}" class="btn btn-danger">CONNEXION</a> </span>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
                ...
                <div class="hero">
                    ...
                    <div class="pull-left login-desc-box-l">
                        <h4 class="paragraph-header">Grace a Suivi-AAC.fr, gardez le controle sur votre conduite accompagnée.</h4>
                    ...
                    <img src="back/img/demo/iphoneview.png" alt="" class="pull-right display-image" style="width:210px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                <div class="well no-padding">
                    {{ Form::open(array('route' => 'post.inscription', 'id' => 'smart-form-register', 'class' => 'smart-form client-form')) }}
                        <header>
                        ...
                        <fieldset>
                            <section>
                                <label class="input"> <i class="icon-append fa fa-envelope"></i>
                                    <input type="email" @if(isset($message) && $message == "Cette adresse mail est déjà utilisée par un de nos membre") class="invalid" @endif name="email" placeholder="Adresse e-mail">
                                    <b class="tooltip tooltip-bottom-right">L'adresse email sera utilisée pour la connexion au site</b> </label>
                            </section>

                            <section>
                                <label class="input"> <i class="icon-append fa fa-lock"></i>
                                    <input type="password" name="password" placeholder="Mot de passe" id="password">
                                    <b class="tooltip tooltip-bottom-right">N'oubiez pas votre mot de passe</b> </label>
                            </section>
                        ...
                        <fieldset>
                            ...
                            <section>
                                <label class="checkbox">
                                    ...
                                    <i></i>Je désire recevoir la newsletter Suivi-AAC.fr</label>
                                <label class="checkbox">
                                    <input type="checkbox" name="terms" id="terms">
                                    <i></i>J'accepte les <a href="#" data-toggle="modal" data-target="#myModal"> termes et conditions d'utilisation</a></label>
                            </section>
                        </fieldset>
                        <footer>
                ...
                <h5 class="text-center">- S'inscrire en utilisant -</h5>
                <ul class="list-inline text-center">
                    <li>
                        <a href="javascript:void(0);" class="btn btn-primary btn-circle"><i class="fa fa-facebook"></i></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" class="btn btn-info btn-circle"><i class="fa fa-google"></i></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" class="btn btn-warning btn-circle"><i class="fa fa-twitter"></i></a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Termes et conditions d'utilisation</h4>
</div>
        ...
        $("#smart-form-register").validate({
            ...
            messages : {
                ...
                password : {
                    ...
                    minlength : 'Veuillez choisir un mot de passe d\'au moins de 4 caractères'
                },
                passwordConfirm : {
