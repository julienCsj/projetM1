...
class TipsService {
    ...
    public static function getTip($pageName) {
        $lesTips = array(
            "financement" => "Cette page permet de lister, d'ajouter et de modifier les sources de financement. Il sera ensuite possible d'assigner une liste de financements à chaque module.",
            ...
            "enseignant" => "Cette page vous permet de visualiser la liste des enseignants et de mettre à jour leur statut.",
            ...
            "heuresExternes" => "Cette page vous permez de déclarer vos heures exterieures à l'IUT. Cela permet au responsable de la planification de générer vos fiches prévisionnelles plus facilement.",
            "config" => "Configuration de base de l'application",
            "generationFiche" => "Cette page vous permet de générer des fiches prévisionnelles d'un enseignant",
            "emploiDuTemps" => "Cette page récapitule les cours à placer sur l'emploi du temps par semaine.",
